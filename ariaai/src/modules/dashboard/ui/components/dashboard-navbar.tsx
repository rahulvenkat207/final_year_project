...
export const DashboardNavbar = () => {
  ...
  return (
    <>
      ...
      <nav className="flex items-center gap-x-2 px-4 py-3 border-b bg-white/95 backdrop-blur-sm">
        ...
        {/* Search button */}
        <Button
          className="h-9 w-[240px] justify-start font-normal text-gray-600 hover:text-gray-900"
          variant="outline"
          size="sm"
